...
/* harmony import */ var _guards_auth_login_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./guards/auth-login.guard */ 6009);
/* harmony import */ var _guards_ruta_protegida_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./guards/ruta-protegida.guard */ 3708);
...
const routes = [
    ...
    {
        path: 'olvide',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_olvide_olvide_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./olvide/olvide.module */ 1816)).then(m => m.OlvidePageModule)
    },
    {
        path: 'organizar',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_organizar_organizar_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./organizar/organizar.module */ 7543)).then(m => m.OrganizarPageModule),
        canLoad: [_guards_auth_login_guard__WEBPACK_IMPORTED_MODULE_0__.AuthLoginGuard]
    },
    {
        path: 'buscar-viaje',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_buscar-viaje_buscar-viaje_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./buscar-viaje/buscar-viaje.module */ 8355)).then(m => m.BuscarViajePageModule),
        canActivate: [_guards_ruta_protegida_guard__WEBPACK_IMPORTED_MODULE_1__.RutaProtegidaGuard]
    },
    {
        path: '**',
...
/***/ 6009:
/*!********************************************!*\
  !*** ./src/app/guards/auth-login.guard.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AuthLoginGuard": () => (/* binding */ AuthLoginGuard)
/* harmony export */ });
...
AuthLoginGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 3708:
/*!************************************************!*\
  !*** ./src/app/guards/ruta-protegida.guard.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RutaProtegidaGuard": () => (/* binding */ RutaProtegidaGuard)
/* harmony export */ });
...
let RutaProtegidaGuard = class RutaProtegidaGuard {
  canActivate(route, state) {
  ...
  verLogeado() {
    return (0,C_Users_josei_Desktop_TeLlevoAPP4_TeLlevoAPP2_TeLlevoApp_conGuardfuncional2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var retorno = false;
      var dato = yield _capacitor_storage__WEBPACK_IMPORTED_MODULE_1__.Storage.get({
        key: 'logeado'
      });
...
RutaProtegidaGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], RutaProtegidaGuard);
