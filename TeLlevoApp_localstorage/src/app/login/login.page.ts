...
export class LoginPage implements OnInit {
  ...
  constructor(private router: Router, public toastController: ToastController, public bdlocalservice: BdLocalService) { }
  ...
  ingresar() {
    ...
    this.bdlocalservice.ingresarguard(this.nombre,this.nro)
  }
